  ...
  'inline-flex items-center gap-1.5 rounded-full px-2.5 py-1 text-[0.7rem] font-medium tracking-[0.06em] uppercase border leading-tight',
  {
    variants: {
      variant: {
        ...
        gold: 'bg-gradient-to-br from-[rgba(216, 139, 106,0.2)] to-[rgba(216, 139, 106,0.05)] text-gold border-[rgba(216, 139, 106,0.3)]',
        ...
        paid: 'bg-[rgba(216, 139, 106,0.1)] text-gold border-[rgba(216, 139, 106,0.2)]',
