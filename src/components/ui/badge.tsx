...
const badgeVariants = cva(
  'inline-flex items-center gap-1.5 rounded-full px-2.5 py-1 text-[0.7rem] font-medium tracking-[0.06em] uppercase border leading-tight',
  {
    variants: {
      variant: {
        default: 'bg-overlay text-muted-foreground border-black/10',
        gold: 'bg-gradient-to-br from-[rgba(212, 184, 150,0.2)] to-[rgba(212, 184, 150,0.05)] text-gold border-[rgba(212, 184, 150,0.3)]',
        ...
        paid: 'bg-[rgba(212, 184, 150,0.1)] text-gold border-[rgba(212, 184, 150,0.2)]',
        ...
        soft: 'bg-overlay text-muted-foreground border-black/10',
      },
    },
