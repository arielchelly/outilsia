      ...
      <div className="container">
        ...
        <div className="grid grid-cols-2 md:grid-cols-12 gap-y-12 gap-x-8 mb-16">
          <div className="col-span-2 md:col-span-4 max-w-xs">
            ...
            >
              <span className="w-1.5 h-1.5 rounded-full bg-gold shadow-[0_0_10px_#E8C878]" />
            ...
            <div className="flex gap-2 mt-6">
              {SOCIALS.map((s) => (
                <a
                  ...
                  rel="noopener"
                  aria-label={s.label}
                  className="w-9 h-9 rounded-full border border-white/10 flex items-center justify-center text-muted-foreground hover:text-gold hover:border-gold/40 hover:bg-[rgba(232,200,120,0.08)] transition-all"
                >
                  {s.icon}
                </a>
              ))}
