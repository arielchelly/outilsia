              ...
              <img
                ...
                onError={(ev) => {
                  ...
                  if (!img.dataset.fallback) {
                    ...
                    if (parent) {
                      parent.style.background = 'linear-gradient(135deg, #D4B896, #A89570)';
                      parent.innerHTML = `<span style="font-family:var(--font-display);color:#0A0A0B;font-weight:600;font-size:0.95rem">${brand.name.charAt(0)}</span>`;
                    }
                  }
                }}
              />
