...
export function ArticleCard({ article }: { article: Article }) {
  return (
    <Link
      ...
      className="group bg-white/[0.015] border border-white/[0.06] rounded-2xl overflow-hidden flex flex-col transition-all duration-500 hover:-translate-y-1 hover:border-[rgba(232,200,120,0.25)] hover:shadow-[0_8px_32px_rgba(0,0,0,0.4),0_0_30px_rgba(232,200,120,0.06)]"
    >
