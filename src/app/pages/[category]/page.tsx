      ...
      <section className="pt-[calc(72px+3rem)] pb-12 relative overflow-hidden">
        ...
        <div className="container-narrow relative">
          ...
          <div className="text-center">
            <span className="inline-flex items-center gap-2 px-4 py-2 bg-elevated border border-black/12 rounded-full text-[0.78rem] text-muted-foreground mb-6">
              <span className="w-1.5 h-1.5 rounded-full bg-electric shadow-[0_0_8px_var(--gold)]" />
          ...
          <Reveal>
            <div className="flex flex-col gap-3">
              {FAQ_DEFAULT.map((f, i) => (
                <details
                  key={i}
                  className="bg-elevated border border-black/[0.06] rounded-md p-5 group open:border-[rgba(212, 184, 150,0.3)]"
                >
